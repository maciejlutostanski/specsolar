...
<svelte:head>
  <title>Specsolar.pl</title>
  <meta name="description" content="Opis musi być" />
</svelte:head>

<!-- ------------------------------------------------------------------------------------------------------ -->
<!-- <div class="relative isolate overflow-hidden bg-primary-500">
  <img
    src="https://specsolar.pl/assets/img/banner1.65512db6.jpg"
    alt=""
  ...
  >
    <div
      class="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#FAB436] opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
  ...
  <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
    ...
    <div class="text-center">
      ...
      <div class="mt-10 flex items-center justify-center gap-x-6">
        <a
          href="#"
          class="rounded-sm bg-primary-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-primary-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-400"
          >Get started</a
        >
...
<div class="relative isolate">
  ...
  <div class="overflow-hidden">
    <div class="mx-auto max-w-7xl px-6 pb-16 pt-24 sm:pt-44 lg:px-8 lg:pt-24">
      <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
        <div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
          ...
          <div class="mt-10 flex items-center gap-x-6">
            <a
              href="/kontakt"
              class="rounded-sm bg-primary-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-primary-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500"
              >Kontakt</a
            >
          </div>
        </div>
...
<div class="bg-white py-24 sm:py-32">
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:text-center">
      <h2 class="text-base font-semibold leading-7 text-primary-500">Deploy faster</h2>
